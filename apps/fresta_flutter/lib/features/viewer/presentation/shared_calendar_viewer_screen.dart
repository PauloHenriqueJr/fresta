                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: const [
                              BoxShadow(color: Color(0x33F9A03F), blurRadius: 20, offset: Offset(0, 8)),
                            ]
                          ),
                          child: const Icon(
                            LucideIcons.gift,
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  gradient: const LinearGradient(
                                                      colors: [Color(0xFFF9A03F), Color(0xFFFDE6B5)],
                                                      begin: Alignment.topLeft,
                                                      end: Alignment.bottomRight,
                                                  ),
                      ...
                      Center(
                        child: OutlinedButton.icon(
                          ...
                          label: const Text('Crie o seu Fresta também', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
                        ),
                      ),
                    ],
                  ),
