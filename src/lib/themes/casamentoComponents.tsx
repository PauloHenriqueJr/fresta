...
// --- Wedding Top Decorations (Distributed Flowers) ---
export const WeddingTopDecorations = () => {
    // Discrete flowers distributed across the top
    const flowers = [
    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-16 pointer-events-none z-[60] overflow-hidden">
            {/* Flowers distributed across top */}
